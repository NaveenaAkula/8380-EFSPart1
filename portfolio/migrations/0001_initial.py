# Generated by Django 2.2.4 on 2020-07-29 03:54
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('category', models.CharField(choices=[('Equity Funds', 'Equity Funds'), ('Bond Funds', 'Bond Funds'), ('Money Market Funds', 'Money Market Funds')], max_length=50)),
